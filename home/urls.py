...
urlpatterns = [
    ...
    path('api/sentiment_type/', views.textTest.as_view(), name='sentiment-type'),
    path('api/sentiment_type2/', views.liveTweetTest.as_view(), name='sentiment-live'),
    path('api/sentiment_type3/', views.uploadTest.as_view(), name='sentiment-type'),
