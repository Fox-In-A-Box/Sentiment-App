window.onload = function () {
  ...
  const resultHandler = (text) => {
    if (text == "Negative") {
      emoji_image = `<img src="../../static/./images/angry2.png" alt="angry face emoji" /><p>${text}</p>`;
    } else if (text == "Positive") {
      emoji_image = `<img src="../../static/./images/good2.png" alt="angry face emoji" /><p>${text}</p>`;
    } else {
      emoji_image = `<img src="../../static/./images/neutral2.png" alt="angry face emoji" /><p>${text}</p>`;
    }
